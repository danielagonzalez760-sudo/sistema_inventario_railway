                        ...
                        <div class="log-card-header">
                            <div class="log-meta">
                                ...
                                <div>
                                    ...
                                    <span class="log-meta-value">{{ $log->usuario->name ?? 'Sistema' }}</span>
                                </div>
                            </div>
                            <div class="log-meta">
                                ...
                                <div>
                                    ...
                                    <span class="log-meta-value">{{ $log->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                            <div class="log-meta">
                                ...
                                <div>
                                    ...
                                    <span class="action-badge
                                        @if(strtolower($log->accion) === 'crear') action-crear
                                        @elseif(strtolower($log->accion) === 'actualizar') action-actualizar
                                        @elseif(strtolower($log->accion) === 'eliminar') action-eliminar
                                        @else action-default @endif">
                                        {{ ucfirst($log->accion) }}
                                    </span>
                                </div>
                            </div>
                            <div class="log-meta">
                                ...
                                <div>
                                    ...
                                    <span class="log-meta-value">{{ $log->modelo_afectado }} #{{ $log->modelo_id }}</span>
                                </div>
                            </div>
                        </div>
