    ...
    <div class="inv-page" x-data="{ openModalId: null }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="inv-toolbar">
                <span class="inv-title"><?php echo e($items->count()); ?> ítem<?php echo e($items->count() !== 1 ? 's' : ''); ?> en inventario</span>
                <a href="<?php echo e(route('items.create')); ?>" class="btn btn-new">
                ...
                <div class="items-grid">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            ...
                            $icon = $icons[$cat] ?? '📋';
                        ?>
                        <div class="item-card <?php echo e($isLow ? 'low-stock' : ''); ?>">
                            ...
                            <div class="card-head">
                                <div style="display:flex;gap:10px;align-items:flex-start;flex:1;min-width:0;">
                                    ...
                                    <div style="min-width:0;">
                                        ...
                                        <div class="card-code"><?php echo e($item->codigo); ?></div>
                                    </div>
                                </div>
                                <span class="cat-badge cat-<?php echo e($cat); ?>"><?php echo e($item->categoria); ?></span>
                            </div>

                            <?php if($isLow && auth()->user()->hasRole('admin')): ?>
                            ...
                            <div class="stock-section">
                                <div class="stock-row">
                                    ...
                                    <span class="stock-value <?php echo e($isLow ? 'stock-warn' : 'stock-ok'); ?>"><?php echo e($item->cantidad); ?></span>
                                </div>
                                <div class="stock-bar-wrap">
                                    <div class="stock-bar-fill <?php echo e($isLow ? 'fill-warn' : 'fill-ok'); ?>" style="width:<?php echo e($pct); ?>%"></div>
                                </div>
                                <div class="stock-meta">
                                    <span>Mínimo: <?php echo e($item->umbral_minimo); ?></span>
                                    <span><?php echo e($isLow ? '⚠️ Por debajo del umbral' : '✓ Stock normal'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="card-info">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($item->proveedor ?? '—'); ?></div>
                                </div>
                                <div class="info-item" style="grid-column:span 2;">
                                    <div class="info-label">Vencimiento</div>
                                    <div class="info-value"><?php echo e($item->fecha_vencimiento ?? '—'); ?></div>
                                </div>
                            </div>

                            <div class="card-actions">
                                <a href="<?php echo e(route('items.edit', $item->id)); ?>" class="act-btn act-edit">✏️ Editar</a>
                                <a href="<?php echo e(route('items.show', $item->id)); ?>" class="act-btn act-detail">🔍 Detalles</a>
                                <a href="<?php echo e(route('items.editStock', $item->id)); ?>" class="act-btn act-stock">📊 Stock</a>
                                <button @click="openModalId = <?php echo e($item->id); ?>" class="act-btn act-delete">🗑️ Eliminar</button>
                            </div>

                            
                            <div x-show="openModalId === <?php echo e($item->id); ?>" x-cloak class="modal-overlay">
...
<?php endif; ?><?php /**PATH C:\Users\Mauricio\Documents\GitHub\sistema_inventario_laboratorio2\resources\views/items/index.blade.php ENDPATH**/ ?>