...
<body>
    ...
    <div class="header">
        ...
        <div class="meta-row">
            <div class="meta-pill"><strong>Periodo:</strong> <?php echo e(ucfirst($periodo)); ?></div>
            <div class="meta-pill"><strong>Desde:</strong> <?php echo e($estadisticas['fecha_inicio']); ?></div>
            <div class="meta-pill"><strong>Hasta:</strong> <?php echo e($estadisticas['fecha_fin']); ?></div>
            <div class="meta-pill"><strong>Generado:</strong> <?php echo e(now()->format('d/m/Y H:i')); ?></div>
        </div>
    </div>
    ...
    <div class="body">
        ...
        <div class="section">
            ...
            <?php if($estadisticas['items_mas_usados']->isEmpty() ?? count($estadisticas['items_mas_usados']) === 0): ?>
                <div class="empty-msg">No hay datos registrados en este periodo.</div>
            <?php else: ?>
                <table class="item-list">
                    <?php $__currentLoopData = $estadisticas['items_mas_usados']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="background:<?php echo e($index % 2 === 0 ? '#fff' : '#f8fafd'); ?>">
                        <td class="item-num"><?php echo e($index + 1); ?></td>
                        <td class="item-name"><?php echo e($item); ?></td>
                        <td class="item-bar-cell">
                            <div class="item-bar-wrap">
                                <div class="item-bar-fill" style="width:<?php echo e(max(15, 100 - ($index * 15))); ?>%"></div>
                            </div>
                        </td>
                        <td style="text-align:right;">
                            <span class="item-badge">Top <?php echo e($index + 1); ?></span>
                        </td>
                    </tr>
        ...
        <div class="section">
            ...
            <table class="reab-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-weight:600;color:#0c2d6b;"><?php echo e($item); ?></td>
                        <td>
                            <?php
                            ...
                            ?>
                            <span class="freq-badge <?php echo e($cls); ?>"><?php echo e(ucfirst($frecuencia)); ?></span>
                        </td>
                        <td style="color:#6b7fa3;font-size:10px;">
                            <?php if(str_contains($freq,'semanal')): ?>
                                Revisar stock cada semana
                            <?php elseif(str_contains($freq,'mensual')): ?>
                                Programar compra mensual
                            <?php elseif(str_contains($freq,'trimestral')): ?>
                                Compra trimestral suficiente
                            <?php elseif(str_contains($freq,'sin')): ?>
        ...
        <div class="section">
            ...
            <?php if($esTexto): ?>
                <div class="empty-msg"><?php echo e($tendencias); ?></div>
            <?php elseif(empty($tendencias) || count($tendencias) === 0): ?>
            ...
            <?php else: ?>
                <table class="tend-table">
                    <thead>
                        <tr>
                            <th>
                                <?php if($periodo === 'diario'): ?> Fecha
                                <?php elseif($periodo === 'semanal'): ?> Año / Semana
                                <?php else: ?> Mes
                                <?php endif; ?>
                            </th>
                    ...
                    <tbody>
                        <?php $maxConsumo = collect($tendencias)->max('total_consumido') ?: 1; ?>
                        ...
                        <tr>
                            <td style="color:#6b7fa3;">
                                <?php if($periodo === 'diario'): ?>
                                    <?php echo e($registro['fecha'] ?? $registro->fecha ?? '-'); ?>

                                <?php elseif($periodo === 'semanal'): ?>
                                    Sem. <?php echo e($registro['semana'] ?? $registro->semana ?? '-'); ?> / <?php echo e($registro['anio'] ?? $registro->anio ?? '-'); ?>

                                    <?php if(isset($registro->rango_fechas)): ?>
                                        <br><span style="font-size:9px;color:#94a3b8;"><?php echo e($registro->rango_fechas); ?></span>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php echo e($registro['mes'] ?? $registro->mes ?? '-'); ?>

                                <?php endif; ?>
                            </td>
                            <td><span class="qty-value"><?php echo e($total); ?></span> unidades</td>
                            <td style="width:120px;">
                                <div class="item-bar-wrap">
                                    <div class="item-bar-fill" style="width:<?php echo e($pct); ?>%;background:linear-gradient(90deg,#854f0b,#f5a623);"></div>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="footer">
        <div class="footer-left">
            Documento generado automáticamente por IUPB-LAB · <?php echo e(now()->format('d/m/Y H:i')); ?><br>
...
</html><?php /**PATH C:\Users\Mauricio\Documents\GitHub\sistema_inventario_laboratorio2\resources\views/admin/reportes/pdf.blade.php ENDPATH**/ ?>